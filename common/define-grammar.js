/**
 * @file Shared Bicep grammar definition for tree-sitter
...
/**
 * Creates a grammar definition for the given dialect.
 *
...
module.exports = function defineGrammar(dialect) {
  ...
  const isBicepParams = dialect === 'bicep_params';
  ...
  return grammar({
    ...
    rules: {
      ...
      region_directive: $ => seq(choice(seq('//', '#region'), '#region'), optional(repeat1($.directive_argument))),
      endregion_directive: $ => seq(choice(seq('//', '#endregion'), '#endregion'), optional(repeat1($.directive_argument))),
      ...
      // Bicep params-only declarations
      ...(isBicepParams ? {
