...
void *tree_sitter_bicep_external_scanner_create() { return scanner_create(); }

void tree_sitter_bicep_external_scanner_destroy(void *payload) { scanner_destroy(payload); }
